...
from app.models.input_entry import InputMode
...
async def create_input_entry(entry_in: InputEntryCreate, session: Session = Depends(get_session)):
...
async def get_input_entry(entry_id: int, session: Session = Depends(get_session)):
...
async def delete_input_entry(entry_id: int, session: Session = Depends(get_session)):
